...
const text = document.createTextNode(`{"name":"CONTRACT","owner":"_W9rKdHKmwYWNlm0CUR9ylgR1Fa3sU_ayQXtSFsVERI","ticker":"WB","balances":{"_W9rKdHKmwYWNlm0CUR9ylgR1Fa3sU_ayQXtSFsVERI":100}}`);
stateEl.append(text);
// });
